        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            {projects.map((proj, index) => (
              <div key={proj._id ?? index} className="flex flex-col gap-2 justify-between items-baseline">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            {education.map((edu, index) => (
              <div key={edu._id ?? index} className="flex justify-between items-baseline">
                <div>
