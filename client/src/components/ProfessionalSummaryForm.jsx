  ...
  return (
    <div className='spcae-y-4'>
        <div className='flex items-center justify-between'>
            ...
            <button disabled={isGenerating} onClick={generateSummary} className='flex utems-center gap-2 px-3 py-1 text-sm bg-purple-100
        ...
        <div className='mt-6'>
            ...
            transition-colors resize-none' placeholder='Write a comelling professional summary that highlights
