...
const ColorPicker = ({selectedColor,onChange}) => {
    ...
    return (
        <div className='relative'>
            ...
            ring-purple-300 hover:ring transition-all px-2 py-2 rounded-lg'>
            ...
            </button>
            {
                isOpen && (
                    ...
                    rounded-md border border-gray-200 shadow-sm'>
                        {
                            colors.map((color)=>(
                                <div onClick={()=>{onChange(color.value); setIsOpen(false)}} key={color.value} className='relative cursor-pointer group
                                flex flex-col'>
                                    ...
                                    </div>
                                    {
                                        selectedColor === color.value && (
                                            <div className='absolute top-0 right-0 bottom-4.5
