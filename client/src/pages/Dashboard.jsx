import { FilePenLineIcon, Loader, LoaderCircleIcon, PencilIcon, PlusIcon, TrashIcon, UploadCloud, UploadCloudIcon, UploadIcon, XIcon } from 'lucide-react'
  ...
  return (
    <div>
      <div className='max-w-7xl mx-auto px-4 py-8'>
        <p className='text-2xl font-medium mb-6 bg-gradient-to-r from-white to-slate-700
            ...
            showCreateResume && (
              ...
              z-10 flex items-center justify-center'>
                ...
                rounded-lg w-full max-w-sm p-6'>
                  ...
                  px-4 py-2 mg-4 focus:border-green-600 ring-green-600' required />
                  <button className='w-full py-2 mt-2 bg-green-600 text-white rounded
            ...
            showUploadResume && (
              ...
              z-10 flex items-center justify-center'>
                ...
                rounded-lg w-full max-w-sm p-6'>
                  ...
                  <button disabled={isLoading} className='w-full py-2 mt-2 bg-green-600 text-white rounded
                  ...
                  <XIcon className='absolute top-4 right-4 text-slate-400
                  hover:text-slate-600 cursor-pointer transition-colors' onClick={() => { setShowUploadResume(false); setTitle('') }
                    } />
                </div>
